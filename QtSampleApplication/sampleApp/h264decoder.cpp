...
bool H264Decoder::initH264Decoder(unsigned width, unsigned height)
{
    ...
    pH264CodecCtx = avcodec_alloc_context3(pH264Codec); //Getting the context for avcodec Like File handle
...
int H264Decoder::libav_decode(AVCodecContext *avctx, AVFrame *frame, int *got_frame, AVPacket *pkt)
{
    ...
    *got_frame = 0;
    ...
    if (pkt)
    {
            ...
            //arguments - avcodec_context and packet from decodeH264()
    ...
    //Arguments- avcodec_context and PictureFrame from avframe
...
{
    AVPacket avpkt; //It is a structure -> Sending size and data in this packet
    ...
    //Sending avpacket to libav_decode()
